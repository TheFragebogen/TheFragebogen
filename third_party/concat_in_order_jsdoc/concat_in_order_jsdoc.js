/*
 * Evaluates the depency of JavaScript classes and concatenates these appropriately.
 * Modified version of grunt-concat-in-order version: https://github.com/miensol/grunt-concat-in-order/commit/d4433b7ce52f73609fe241af2d3e2c964e07d9f4
 * In difference to the original, this version uses the JSDoc tags "@class" and "@augments" (for inheritance) / "@requires" (for usage).
 *
 * Provides task: concat_in_order_jsdoc
 *
...
module.exports = function (grunt) {
    ...
    grunt.registerMultiTask('concat_in_order_jsdoc', 'Concatenates files in order', function () {
